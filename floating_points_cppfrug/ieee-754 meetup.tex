...
\end{frame}  
  ...
  \defverbatim[colored]\ffwithpow{
\begin{lstlisting}[language=C++,basicstyle=\ttfamily,keywordstyle=\color{blue}]
template <typename T>
T f(T a, T b) {
  return T{333.75}*b*b*b*b*b*b+a*a*
  (T{11.0}*a*a*b*b-b*b*b*b*b*b
  -T{121.0}*b*b*b*b-T{2.0})
  +T{5.5}*b*b*b*b*b*b*b*b+a/(T{2.0}*b);
}
template <typename T>
T f_with_pow(T a, T b) {
  return T{333.75}*pow(b,6)+pow(a,2)*
  (T{11.0}*pow(a,2)*pow(b,2)-pow(b,6)
  -T{121.0}*pow(b,4)-T{2.0})
  +T{5.5}*pow(b,8)+a/(T{2.0}*b);
}
\end{lstlisting}
}  
...
\end{frame}
  ...
  \defverbatim[colored]\floatvsdouble{
\begin{lstlisting}[language=C++,basicstyle=\ttfamily,keywordstyle=\color{blue}]
f<float>(77617.0, 33096.0)
f_with_pow<float>(77617.0, 33096.0)
f<double>(77617.0, 33096.0)
f_with_pow<double>(77617.0, 33096.0)
\end{lstlisting}
} 
...
\item float with pow :  $-6.3382530011411470075*10^{29}$
\item double : $1.1726039400531786949$
\item double with pow : $-1.1805916207174113034*10^{21}$
\item \textcolor{white}{ } 
    \end{itemize}
  \end{frame}
